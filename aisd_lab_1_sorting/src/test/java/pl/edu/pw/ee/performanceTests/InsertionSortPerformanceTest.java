...
public class InsertionSortPerformanceTest {
    ...
    private final String optimisticFile = "insertionSortOptimisticPerformanceData.txt";
    private final String pesimisticFile = "insertionSortPesimisticPerformanceData.txt";
    private final String randomFile = "insertionSortrandomPerformanceData.txt";
