...
public class RefAlgorithmPerformanceTest {
    ...
    private final String optimisticFile = "refAlgorithmOptimisticPerformanceData.txt";
    private final String pesimisticFile = "refAlgorithmPesimisticPerformanceData.txt";
    private final String randomFile = "refAlgorithmrandomPerformanceData.txt";
