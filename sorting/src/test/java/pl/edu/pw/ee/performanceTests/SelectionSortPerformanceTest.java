...
public class SelectionSortPerformanceTest {
    ...
    private final String optimisticFile = "selectionSortOptimisticPerformanceData.txt";
    private final String pesimisticFile = "selectionSortPesimisticPerformanceData.txt";
    private final String randomFile = "selectionSortrandomPerformanceData.txt";
